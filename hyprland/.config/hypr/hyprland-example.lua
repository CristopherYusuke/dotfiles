...
hl.bind(mainMod .. " + CTRL + SHIFT + left", function()
	hl.dsp.window.move({ out_of_group = "l" })
end)
hl.bind(mainMod .. " + CTRL + SHIFT + right", function()
	hl.dsp.window.move({ out_of_group = "r" })
end)
hl.bind(mainMod .. " + CTRL + SHIFT + up", function()
	hl.dsp.window.move({ out_of_group = "u" })
end)
hl.bind(mainMod .. " + CTRL + SHIFT + down", function()
	hl.dsp.window.move({ out_of_group = "d" })
end)
